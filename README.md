...
# Solving
![giff](https://j.gifs.com/yEo2V2.gif)
...
```
 ...
 - [Resolução da ficha de avaliação](https://github.com/tanjilk/solving/blob/master/m%C3%B3dulo%204/teste.cpp)
### Modulo 17
#### Tratamento de Erros
...
Exemplo de um programa em C++ que pede a um número ao utilizador e grava num ficheiro de texto o resultado da tabuada desse número.
...
- [Estrutura da ficha](https://github.com/tanjilk/estrutura-inscricao) 
